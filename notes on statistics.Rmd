...
```{r,echo=FALSE}
g <- plot_norm(lb = -1, ub = 1, lb1 = -2, ub1 = 2, lb2 = -Inf, ub2 = Inf, alpha = .2, col = "blue", col1 = "blue", col2 = "blue")
g <- g + annotate("text", x = 1, y = -0.02, label = "sigma", parse = TRUE)
g <- g + annotate("text", x = -1, y = -0.02, label = "-sigma", parse = TRUE)
g <- g + annotate("text", x = 2, y = -0.02, label = "2*sigma", parse = TRUE)
g <- g + annotate("text", x = -2, y = -0.02, label = "-2*sigma", parse = TRUE)
g 
```   
